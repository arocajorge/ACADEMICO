...
namespace Core.Data.Academico
{
    public class aca_AnioLectivo_Curso_Plantilla_Parametrizacion_Data
    {
        ...
        public List<aca_AnioLectivo_Curso_Plantilla_Parametrizacion_Info> GetList_x_Curso_x_Plantilla(int IdEmpresa, int IdSede, int IdAnio, int IdNivel, int IdJornada, int IdCurso, int IdPlantilla)
        {
            try
            {
                List<aca_AnioLectivo_Curso_Plantilla_Parametrizacion_Info> Lista = new List<aca_AnioLectivo_Curso_Plantilla_Parametrizacion_Info>();
                ...
                using (EntitiesAcademico db = new EntitiesAcademico())
                {
                    var lst = db.vwaca_AnioLectivo_Curso_Plantilla_Parametrizacion.Where(q => q.IdEmpresa == IdEmpresa && q.IdSede == IdSede && q.IdAnio == IdAnio && q.IdNivel == IdNivel && q.IdJornada == IdJornada && q.IdCurso == IdCurso && q.IdPlantilla==IdPlantilla).ToList();
                    foreach (var item in lst)
                    {
                        Lista.Add(new aca_AnioLectivo_Curso_Plantilla_Parametrizacion_Info
                        {
