...
{
    public class ACA_064_Data
    {
        public List<ACA_064_Info> GetList(int IdEmpresa, int IdAnio, int IdSede, int IdNivel, int IdJornada, int IdCurso, int IdParalelo, bool MostrarRetirados)
        {
            try
            {
                ...
                List<ACA_064_Info> Lista = new List<ACA_064_Info>();
                using (SqlConnection connection = new SqlConnection(CadenaDeConexion.GetConnectionString()))
                {
                    ...
                    + " sn.OrdenNivel, nj.NomJornada, nj.OrdenJornada, jc.NomCurso, jc.OrdenCurso, cp.NomParalelo, cp.OrdenParalelo,p.pe_nombreCompleto, m.Observacion, pl.NomPlantilla, plt.NomPlantillaTipo "
                    ...
                    + " left outer join aca_Plantilla pl WITH (nolock) on pl.IdEmpresa=m.IdEmpresa and pl.IdPlantilla = m.IdPlantilla "
                    + " left outer join aca_PlantillaTipo plt WITH (nolock) on plt.IdEmpresa = pl.IdEmpresa and plt.IdTipoPlantilla = pl.IdTipoPlantilla"
