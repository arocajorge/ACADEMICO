        ...
        public List<ACA_055_Info> GetList(int IdEmpresa, int IdAnio, int IdSede, int IdNivel, int IdJornada, int IdCurso)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(CadenaDeConexion.GetConnectionString()))
                {
                    ...
                    + " c.ca_descripcion, sn.NomSede, sn.NomNivel, sn.OrdenNivel, p.CodCatalogoCONADIS, p.PorcentajeDiscapacidad, p.NumeroCarnetConadis, cat.ca_descripcion AS TipoDiscapacidad "
                    ...
                    + " dbo.tb_Catalogo AS cat ON cat.CodCatalogo = p.CodCatalogoCONADIS "
                    ...
                    while (reader.Read())
                    {
                        Lista.Add(new ACA_055_Info
                        {
                            ...
                            Porcentaje = string.IsNullOrEmpty(reader["PorcentajeDiscapacidad"].ToString()) ? null : reader["PorcentajeDiscapacidad"].ToString(),
