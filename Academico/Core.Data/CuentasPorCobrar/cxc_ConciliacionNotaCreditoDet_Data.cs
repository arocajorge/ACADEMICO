                ...
                using (SqlConnection connection = new SqlConnection(CadenaDeConexion.GetConnectionString()))
                {
                    ...
                    while (reader.Read())
                    {
                        Lista.Add(new cxc_ConciliacionNotaCreditoDet_Info
                        {
                            ...
                            Observacion = string.IsNullOrEmpty(reader["vt_Observacion"].ToString()) ? null : reader["vt_Observacion"].ToString(),
                            ...
                            vt_total = string.IsNullOrEmpty(reader["Valor"].ToString()) ? (double?)null : Convert.ToDouble(reader["Valor"]),
                            Saldo = 0,
                            vt_Subtotal = 0,
                            vt_iva = 0,
