...
using Core.Bus.CuentasPorPagar;
...
using Core.Web.Areas.Contabilidad.Controllers;
...
namespace Core.Web.Areas.Banco.Controllers
{
    ...
    public class NotaDeDebitoBancoController : Controller
    {
        ...
        private bool validar(ba_Cbte_Ban_Info i_validar, ref string msg)
        {
            ...
            var param = bus_parametros.get_info(i_validar.IdEmpresa);
        ...
        public ActionResult Index()
        {
            ...
            #region Permisos
            aca_Menu_x_seg_usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), Convert.ToInt32(SessionFixed.IdSede), SessionFixed.IdUsuario, "Banco", "NotaDeDebitoBanco", "Index");
