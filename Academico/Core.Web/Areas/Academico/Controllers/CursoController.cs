...
namespace Core.Web.Areas.Academico.Controllers
{
    public class CursoController : Controller
    {
        ...
        public ActionResult Nuevo(aca_Curso_Info model)
        {
            ...
            return RedirectToAction("Consultar", new { IdEmpresa = model.IdEmpresa, IdCurso = model.IdCurso, Exito = true });
        }

        public ActionResult Consultar(int IdEmpresa = 0, int IdCurso = 0, bool Exito = false)
        {
            #region Validar Session
            if (string.IsNullOrEmpty(SessionFixed.IdTransaccionSession))
                return RedirectToAction("Login", new { Area = "", Controller = "Account" });
