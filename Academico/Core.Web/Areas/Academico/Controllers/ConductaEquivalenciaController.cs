...
namespace Core.Web.Areas.Academico.Controllers
{
    public class ConductaEquivalenciaController : Controller
    {
        ...
        [ValidateInput(false)]
        public ActionResult GridViewPartial_ConductaEquivalencia()
        {
        ...
        public ActionResult Nuevo(aca_AnioLectivoConductaEquivalencia_Info model)
        {
            ...
            return RedirectToAction("Modificar", new { IdEmpresa = model.IdEmpresa, IdAnio = model.IdAnio, Secuencia = model.Secuencia, Exito = true });
        }
