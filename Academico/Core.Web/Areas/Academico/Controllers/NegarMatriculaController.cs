...
{
    public class NegarMatriculaController : Controller
    {
        #region Variables
        aca_Rubro_Bus bus_rubro = new aca_Rubro_Bus();
        aca_PermisoMatricula_List Lista_NegarMatricula = new aca_PermisoMatricula_List();
        ...
        public ActionResult Index()
        {
            ...
            aca_PermisoMatricula_Info model = new aca_PermisoMatricula_Info
            {
                ...
                IdCatalogoPERNEG = Convert.ToInt32(cl_enumeradores.eCatalogoPermisoMatricula.NEGAR),
            ...
            Lista_NegarMatricula.set_list(lista, Convert.ToDecimal(SessionFixed.IdTransaccionSession));
            #region Permisos
            aca_Menu_x_seg_usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), Convert.ToInt32(SessionFixed.IdSede), SessionFixed.IdUsuario, "Academico", "NegarMatricula", "Index");
        ...
        [ValidateInput(false)]
        public ActionResult GridViewPartial_NegarMatricula(bool Nuevo = false, bool Modificar = false, bool Anular = false)
        {
            SessionFixed.IdTransaccionSessionActual = Request.Params["TransaccionFixed"] != null ? Request.Params["TransaccionFixed"].ToString() : SessionFixed.IdTransaccionSessionActual;

            List<aca_PermisoMatricula_Info> model = Lista_NegarMatricula.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
            ViewBag.Nuevo = Nuevo;
        ...
        public ActionResult Nuevo()
        {
            ...
            #region Permisos
            aca_Menu_x_seg_usuario_Info inf = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), Convert.ToInt32(SessionFixed.IdSede), SessionFixed.IdUsuario, "Academico", "NegarMatricula", "Index");
            if (!inf.Nuevo)
        ...
        public ActionResult Nuevo(aca_PermisoMatricula_Info model)
        {
            ...
            return RedirectToAction("Consultar", new { IdEmpresa = model.IdEmpresa, IdPermiso = model.IdPermiso, Exito = true });
        }
    ...
    public class aca_PermisoMatricula_List
    {
        string Variable = "aca_PermisoMatricula_Info";
        public List<aca_PermisoMatricula_Info> get_list(decimal IdTransaccionSession)
        {
            if (HttpContext.Current.Session[Variable + IdTransaccionSession.ToString()] == null)
            {
                List<aca_PermisoMatricula_Info> list = new List<aca_PermisoMatricula_Info>();

                HttpContext.Current.Session[Variable + IdTransaccionSession.ToString()] = list;
            }
            return (List<aca_PermisoMatricula_Info>)HttpContext.Current.Session[Variable + IdTransaccionSession.ToString()];
        }

        public void set_list(List<aca_PermisoMatricula_Info> list, decimal IdTransaccionSession)
        {
            HttpContext.Current.Session[Variable + IdTransaccionSession.ToString()] = list;
        }
    }
