...
{
    public partial class ACA_051_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_051_Bus bus_rpt = new ACA_051_Bus();
        public ACA_051_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_051_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_051_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo);
