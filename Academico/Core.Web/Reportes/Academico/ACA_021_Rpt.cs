...
{
    public partial class ACA_021_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ACA_021_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_021_Bus bus_rpt = new ACA_021_Bus();
            List<ACA_021_Info> lst_rpt = new List<ACA_021_Info>();
