...
{
    public partial class ACA_064_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_064_Bus bus_rpt = new ACA_064_Bus();
        public ACA_064_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_064_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_064_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, MostrarRetirados);
