...
{
    public partial class ACA_028_Profesores_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_028_Profesores_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_028_Profesores_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_028_Profesores_Bus bus_rpt = new ACA_028_Profesores_Bus();
            List<ACA_028_Profesores_Info> lst_rpt = new List<ACA_028_Profesores_Info>();
