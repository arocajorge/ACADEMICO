...
{
    public partial class ACA_032_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ACA_032_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_032_Bus bus_rpt = new ACA_032_Bus();
            List<ACA_032_Info> lst_rpt = new List<ACA_032_Info>();
            lst_rpt = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, IdCatalogoParcialTipo, MostrarRetirados);

            List<ACA_032_Info> ListaGrafico = new List<ACA_032_Info>();
