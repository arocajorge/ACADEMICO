...
{
    public partial class ACA_028_EstudianteSupletorio_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_028_EstudianteSupletorio_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_028_EstudianteSupletorio_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_028_Supletorio_Bus bus_rpt = new ACA_028_Supletorio_Bus();
            List<ACA_028_Supletorio_Info> lst_rpt = new List<ACA_028_Supletorio_Info>();
