...
{
    public partial class ACA_053_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_053_Bus bus_rpt = new ACA_053_Bus();
        public ACA_053_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_053_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_053_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, MostrarRetirados);
