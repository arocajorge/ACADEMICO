...
{
    public partial class ACA_029_PromediosBajos_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_029_PromediosBajos_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_029_PromediosBajos_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_029_PromediosBajos_Bus bus_rpt = new ACA_029_PromediosBajos_Bus();
            List<ACA_029_PromediosBajos_Info> lst_rpt = new List<ACA_029_PromediosBajos_Info>();
