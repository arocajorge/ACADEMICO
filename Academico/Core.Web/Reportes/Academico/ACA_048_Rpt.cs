...
{
    public partial class ACA_048_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ACA_048_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var quimestre = bus_catalogo.GetInfo(IdCatalogoParcialTipo);
            if (quimestre != null)
            {
            ...
            ACA_048_Bus bus_rpt = new ACA_048_Bus();
            List<ACA_048_Info> lst_rpt = new List<ACA_048_Info>();
            lst_rpt = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, IdMateria);

            this.DataSource = lst_rpt;
        }

        private void Rendimiento_SubRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ((XRSubreport)sender).ReportSource.Parameters["p_IdCatalogoParcialTipo"].Value = p_IdCatalogoParcialTipo.Value == null ? 0 : Convert.ToInt32(p_IdCatalogoParcialTipo.Value);
        ...
        private void SinPromedios_SubRpt_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ((XRSubreport)sender).ReportSource.Parameters["p_IdEmpresa"].Value = p_IdEmpresa.Value == null ? 0 : Convert.ToInt32(p_IdEmpresa.Value);
            ((XRSubreport)sender).ReportSource.Parameters["p_IdSede"].Value = p_IdSede.Value == null ? 0 : Convert.ToInt32(p_IdSede.Value);
            ((XRSubreport)sender).ReportSource.Parameters["p_IdAnio"].Value = p_IdAnio.Value == null ? 0 : Convert.ToInt32(p_IdAnio.Value);
