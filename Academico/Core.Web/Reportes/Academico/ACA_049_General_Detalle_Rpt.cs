...
{
    public partial class ACA_049_General_Detalle_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_049_General_Detalle_Bus bus_rpt = new ACA_049_General_Detalle_Bus();
        public ACA_049_General_Detalle_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_049_General_Detalle_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_049_General_Detalle_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdMatricula);
