...
{
    public partial class ACA_048_Promedios_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_048_Promedios_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_048_Promedios_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_048_Promedios_Bus bus_rpt = new ACA_048_Promedios_Bus();
            List<ACA_048_Promedios_Info> lst_rpt = new List<ACA_048_Promedios_Info>();
