...
{
    public partial class ACA_029_SinPromedios_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_029_SinPromedios_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_029_SinPromedios_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_029_SinPromedios_Bus bus_rpt = new ACA_029_SinPromedios_Bus();
            List<ACA_029_SinPromedios_Info> lst_rpt = new List<ACA_029_SinPromedios_Info>();
