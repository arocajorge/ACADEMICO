...
{
    public partial class ACA_028_EstudiantesSinExamen_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_028_EstudiantesSinExamen_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_028_EstudiantesSinExamen_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_028_SinExamen_Bus bus_rpt = new ACA_028_SinExamen_Bus();
            List<ACA_028_SinExamen_Info> lst_rpt = new List<ACA_028_SinExamen_Info>();
