...
{
    public partial class ACA_057_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_057_Bus bus_rpt = new ACA_057_Bus();
        public ACA_057_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_057_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_057_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo);
