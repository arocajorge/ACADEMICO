...
{
    public partial class ACA_055_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_055_Bus bus_rpt = new ACA_055_Bus();
        public ACA_055_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_055_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_055_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, MostrarRetirados);
