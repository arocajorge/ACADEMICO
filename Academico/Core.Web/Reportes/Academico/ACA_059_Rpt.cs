...
{
    public partial class ACA_059_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_059_Bus bus_rpt = new ACA_059_Bus();
        public ACA_059_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_059_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_059_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, MostrarRetirados);
                ...
                if (info_sede != null)
                {
                    Rector.Text = info_sede.NombreRector;
                    Secretaria.Text = info_sede.NombreSecretaria;
