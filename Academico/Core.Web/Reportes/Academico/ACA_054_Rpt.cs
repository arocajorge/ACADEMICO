...
{
    public partial class ACA_054_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_054_Bus bus_rpt = new ACA_054_Bus();
        public ACA_054_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_054_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_054_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, MostrarRetirados);
