...
{
    public partial class ACA_028_ConductaBaja_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_028_ConductaBaja_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_028_ConductaBaja_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_028_ConductaBaja_Bus bus_rpt = new ACA_028_ConductaBaja_Bus();
            List<ACA_028_ConductaBaja_Info> lst_rpt = new List<ACA_028_ConductaBaja_Info>();
