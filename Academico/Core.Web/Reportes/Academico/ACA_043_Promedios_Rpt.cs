...
{
    public partial class ACA_043_Promedios_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        tb_empresa_Bus bus_empresa = new tb_empresa_Bus();
        public string usuario { get; set; }
        public string empresa { get; set; }
        public ACA_043_Promedios_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_043_Promedios_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_043_Promedios_Bus bus_rpt = new ACA_043_Promedios_Bus();
            List<ACA_043_Promedios_Info> lst_rpt = new List<ACA_043_Promedios_Info>();
