...
{
    public partial class ACA_037_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_037_Bus bus_rpt = new ACA_037_Bus();
        public ACA_037_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_037_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_037_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, IdProfesor, MostrarRetirados);
