...
{
    public partial class ACA_028_PromediosXSexo_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_028_PromediosXSexo_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_028_PromediosXSexo_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_028_PromedioXSexo_Bus bus_rpt = new ACA_028_PromedioXSexo_Bus();
            List<ACA_028_PromedioXSexo_Info> lst_rpt = new List<ACA_028_PromedioXSexo_Info>();
