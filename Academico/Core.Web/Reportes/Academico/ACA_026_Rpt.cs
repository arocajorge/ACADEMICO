...
{
    public partial class ACA_026_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ACA_026_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_026_Bus bus_rpt = new ACA_026_Bus();
            List<ACA_026_Info> lst_rpt = new List<ACA_026_Info>();
