...
{
    public partial class ACA_028_Dece_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public ACA_028_Dece_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_028_Dece_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_028_Dece_Bus bus_rpt = new ACA_028_Dece_Bus();
            List<ACA_028_Dece_Info> lst_rpt = new List<ACA_028_Dece_Info>();
