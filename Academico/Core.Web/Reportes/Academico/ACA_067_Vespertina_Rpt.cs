...
{
    public partial class ACA_067_Vespertina_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        
        ACA_067_Bus bus_rpt = new ACA_067_Bus();
        public ACA_067_Vespertina_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_067_Vespertina_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<ACA_067_Info> Lista = bus_rpt.GetList(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, MostrarRetirados);
