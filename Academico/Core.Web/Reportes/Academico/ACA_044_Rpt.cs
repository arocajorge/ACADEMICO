...
{
    public partial class ACA_044_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ACA_044_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_044_Bus bus_rpt = new ACA_044_Bus();
            List<ACA_044_Info> lst_rpt = new List<ACA_044_Info>();
