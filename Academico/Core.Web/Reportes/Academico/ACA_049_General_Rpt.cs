...
{
    public partial class ACA_049_General_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }
        public ACA_049_General_Rpt()
        {
            InitializeComponent();
        }

        private void ACA_049_General_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ACA_049_General_Bus bus_rpt = new ACA_049_General_Bus();
            List<ACA_049_General_Info> lst_rpt = new List<ACA_049_General_Info>();
