...
{
    public partial class FAC_003_aplicaciones_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public FAC_003_aplicaciones_Rpt()
        {
            InitializeComponent();
        }

        private void FAC_003_aplicaciones_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            FAC_003_aplicaciones_Bus bus_rpt = new FAC_003_aplicaciones_Bus();
            List<FAC_003_aplicaciones_Info> lst_rpt = bus_rpt.get_list(IdEmpresa_nt, IdSucursal_nt, IdBodega_nt, IdNota_nt);
