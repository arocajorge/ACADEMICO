...
{
    public partial class FAC_005_Resumen_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }
        FAC_005_Bus bus_rpt = new FAC_005_Bus();

        public FAC_005_Resumen_Rpt()
        {
            InitializeComponent();
        }

        private void FAC_005_Resumen_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
