...
{
    public partial class CXC_009_Resumen_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        CXC_009_Bus bus_rpt = new CXC_009_Bus();
        public CXC_009_Resumen_Rpt()
        {
            InitializeComponent();
        }

        private void CXC_009_Resumen_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                this.xrPivotGrid1.DataSource = Lista;
