...
{
    public partial class CXC_004_Saldo_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        CXC_004_Bus bus_rpt = new CXC_004_Bus();
        public string usuario { get; set; }
        public string empresa { get; set; }
        public CXC_004_Saldo_Rpt()
        {
            InitializeComponent();
        }

        private void CXC_004_Saldo_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            Lista = bus_rpt.Getlist_Saldo(IdEmpresa, FechaCorte);
