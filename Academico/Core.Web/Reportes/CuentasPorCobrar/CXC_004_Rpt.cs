...
namespace Core.Web.Reportes.CuentasPorCobrar
{
    public partial class CXC_004_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void CXC_004_Rptcs_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                List<CXC_004_Info> Lista = bus_rpt.Getlist(IdEmpresa, IdUsuario, FechaCorte);
