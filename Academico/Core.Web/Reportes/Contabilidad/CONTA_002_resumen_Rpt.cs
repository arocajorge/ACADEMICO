...
{
    public partial class CONTA_002_resumen_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }
        public CONTA_002_resumen_Rpt()
        {
            InitializeComponent();
        }

        private void CONTA_002_resumen_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
